...
/**
 * Abstract base class for parsing STL (stereolithography) files. Subclasses of
 * this class implement parsing the two formats of STL files: binary and
 * ASCII.<p>
 * @author Dipl. Ing. Paul Szawlowski - University of Vienna, Dept of Medical
 * Computer Sciences
 * @version $Revision: 1.3 $ Copyright (c) Dipl. Ing. Paul Szawlowski<p>
 */
abstract class STLParser {
     ...
     * Constructor.
     *
     * @param strict Attempt to deal with crappy data or short downloads. Will
     * try to return any useable geometry.
     */
     ...
     * objects in file. If name is not contained then the appropriate string is
     * <code>null</code>.
     */
    ...
    /**
     * Get number of objects in file. {@link #parse} must be called once before
     * calling this method.
     */
    int getNumOfObjects() {
     ...
     * when strictParsing is false. Means things like getNumOfFacets might be
     * larger then reality.
     */
